...
%   %The soma is separated from
% connected neurites by performing a morphological opening (erosion
% followed by dilation) using a disk with radius 15 pixels as
% the structural element (Supplementary Fig. 1D and E).
